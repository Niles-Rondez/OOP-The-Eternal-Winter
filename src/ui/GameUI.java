...
public class GameUI {
    ...
    private JButton newGameButton, loadGameButton, settingsButton, exitButton, adventureButton, noticeboardButton, merchantButton, clinicButton,
            ...
            sleepButton, chestButton, innKeeperButton, eatButton, questButton;
...
// Adjust button size
        ...
        buyButton = createChoiceButton("Free Heal", choicebuttonSize);
        sellButton = createChoiceButton("Buy Full Heal", choicebuttonSize);
        townButton = createChoiceButton("Town", choicebuttonSize);
